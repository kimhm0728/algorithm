...
public class B_2550 {
	...
	private static List<Node> list = new ArrayList<>(); // ����Ʈ��
	private static List<Integer> level[]; // �� ������ � ��尡 �����ִ��� ����
	private static int n;
	private static int num = 0; // �� ��ȣ
	private static int maxLevel = 0; // Ʈ���� �ִ� ����
